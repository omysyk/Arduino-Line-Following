...
void loop() {
  ...
  /*
    ...
    while(1) {
      num1 = digitalRead(lineTracking1);
      if(num1) {
        Serial.println("num1: true");
        _mleft();
      } else {
        Serial.println("num1: false");
        break;
      }
    }
  } else if(num3) {
    Serial.println("num3: true");
    while(1) {
      num3 = digitalRead(lineTracking3);
      if(num3) {
        Serial.println("num3: true");
        ...
        Serial.println("num3:false, break");
        break;
      }
    }
  } else {
    ...
    num3 = digitalRead(lineTracking3);
    if(num1 && !num3){
      Serial.println("num1: true, num3:false");
      _mleft();
      while(1){
      ...
      Serial.println("num3: true, num1: false");
      _mright();
      while(1){
        num1 = digitalRead(lineTracking1);
        if(num1) {
          Serial.println("num1: true, break");
            break;
        }
      }
    } else {
